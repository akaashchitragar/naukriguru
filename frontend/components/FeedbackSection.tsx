    ...
    <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
      ...
      <div className="mt-8 flex flex-wrap gap-3 justify-end">
        ...
        <button 
          ...
          className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-deep-blue hover:bg-deep-blue/90 focus:outline-none"
        >
