      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Modal header */}
            <div className="bg-gradient-to-r from-deep-blue to-[#1a3a5f] px-6 py-8 text-white">
              <div className="mb-2 flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="mr-2 h-8 w-8 text-accent-orange"
                >
              ...
              <p className="text-gray-300">
                Sign in to continue your journey to career success
              </p>
            </div>
