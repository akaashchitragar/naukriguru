        ...
        <div className="relative">
          ...
          <div className="grid gap-12 md:grid-cols-4">
            {steps.map((step, index) => (
              ...
              >
                <div className="z-10 mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-deep-blue text-white shadow-lg">
                  {step.icon}
                </div>
                <div className="z-10 mb-2 text-xl font-bold text-accent-orange">{step.number}</div>
                <h3 className="mb-2 text-xl font-semibold text-deep-blue">{step.title}</h3>
