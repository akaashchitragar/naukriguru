      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-deep-blue text-white">
                {feature.icon}
              </div>
              <h3 className="mb-3 text-xl font-semibold text-deep-blue">{feature.title}</h3>
